def build_curve_advice_labels_object(
    ...
    """
    Input:
    - df_ref: DataFrame REF of single curve (already isolated)
    - df_me: DataFrame ME of single curve (already isolated)
    ...
    NOTE:
    - NO GPS in physical
    - Parameters are fixed, can be changed according to track
    """
    import math
    import numpy as np
    import pandas as pd
